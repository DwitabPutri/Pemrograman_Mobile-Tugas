...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _validatePhone(String value) {
    bool isValid =
        value.isNotEmpty && int.tryParse(value) != null && value.length >= 10;
    setState(() {
      _phoneError = !isValid;
    });
  }
                  ...
                  child: Column(
                    ...
                    children: [
                            ...
                            child: Column(
                              children: [
                                ...
                                SizedBox(
                                    height:
                                        4),
                                Text('Telepon', style: judulTextField2),
                              ],
                            ),
                          ),
                          SizedBox(width: 13),
                      ...
                      if (_phoneError)
                        Padding(
                          padding: const EdgeInsets.only(top: 7.0, left: 7.0),
                          child: Text('Nomor telepon tidak valid',
                              style: errorMsg),
                        ),
                      Padding(
                                  ...
                                  return AlertDialog(
                                    ...
                                    content: Column(
                                      ...
                                      children: [
                                        Center(
                                          child: Text(
                                            'Akunmu telah terdaftar. Selamat menggunakan Finease!',
                                            textAlign: TextAlign
                                                .center,
                                            style: inputField,
                                          ),
